...
<head>
    ...
    <meta name="description"
        ...
        <link rel="canonical" href="https://pearlcon.com/contact" />
<meta property="og:title" content="Contact Us — Pearlcon Business Services" />
<meta property="og:url" content="https://pearlcon.com/contact" />
    ...
    <style>
        ...
        * {
        ...
        .contact-form-card {
            ...
            padding: 36px 32px;
            border: 1px solid var(--line);
            box-shadow: 0 10px 30px rgba(10, 22, 38, 0.05);
        }
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        ...
        {
          "@type": "WebPage",
          "@id": "https://pearlcon.com/contact#webpage",
          "url": "https://pearlcon.com/contact",
          "name": "Contact Us — Pearlcon Business Services",
          "description": "Get in touch with Pearlcon Business Services Ltd for industrial procurement, sourcing and RFQ inquiries.",
          "isPartOf": {
...
<body>
    ...
    <div class="contact-hero">
        <div class="wrap">
            <span class="eyebrow" style="color: var(--amber-2);">Get In Touch</span>
            <h1 style="margin-top: 8px;">Contact Pearlcon Business Services</h1>
            <p>Have questions about global industrial sourcing, procurement, or product quotes? Reach out to our UK team directly.</p>
        </div>
    </div>
