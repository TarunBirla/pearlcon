...
<head>
    ...
    <meta name="description"
        ...
        <link rel="canonical" href="https://pearlcon.com/registration-request" />
<meta property="og:title" content="Request a Quote — Pearlcon Business Services" />
<meta property="og:url" content="https://pearlcon.com/registration-request" />
...
========================= */
        ...
        .request-card {
            ...
            padding: 42px;
            box-shadow:
                0 30px 80px -35px rgba(10, 22, 38, 0.30),
                0 5px 20px rgba(10, 22, 38, 0.04);
        }
        ...
        .request-section-number {
            ...
            justify-content: center;
            background: rgba(233, 132, 35, 0.12);
            border: 1px solid rgba(233, 132, 35, 0.28);
            color: #e98423;
            font-family: "IBM Plex Mono", monospace;
            font-size: 11px;
            font-weight: 600;
        ...
        .request-field textarea:focus {
            ...
            border-color: #e98423;
            box-shadow:
                0 0 0 3px rgba(233, 132, 35, 0.10),
                0 8px 20px -15px rgba(233, 132, 35, 0.5);
        }
        ...
        .activity-option label::before {
            content: "";
            width: 19px;
            height: 19px;
            flex: 0 0 19px;
            border: 1.5px solid #c6ced7;
            border-radius: 5px;
            background: #fff;
        ...
        .activity-option input:checked+label {
            ...
            background: #fff8ef;
            color: #8a4b10;
            box-shadow: 0 8px 24px -18px rgba(233, 132, 35, 0.7);
        }

        .activity-option input:checked+label::before {
            border-color: #e98423;
            background:
                linear-gradient(135deg, #e98423, #c96a15);
            box-shadow:
                inset 0 0 0 4px #fff8ef;
        }
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        ...
        {
          "@type": "WebPage",
          "@id": "https://pearlcon.com/registration-request#webpage",
          "url": "https://pearlcon.com/registration-request",
          "name": "Request a Quote — Pearlcon Business Services",
          "description": "Submit your RFQ and procurement requirements to Pearlcon for competitive pricing and fast global delivery.",
          "isPartOf": {
    ...
    <div class="request-page">
        ...
        <div class="request-container">
            ...
            <div class="request-header">
                ...
                <p>
                    Share your requirements with our sourcing team.
            ...
            <div class="request-card">
                ...
                <form action="{{ route('registration.request.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="request-section">
                        ...
                        <div class="request-section-title">
                            <div class="request-section-number">
                                01
                            </div>

                            <h2>Request Quote Information</h2>
                        </div>
                        ...
                        <div class="request-grid">
                            ...
                            <div class="request-field">
                                ...
                                <input type="tel" name="phone" value="{{ old('phone') }}" placeholder="+44 000 000 0000"
                                    required>
                            </div>
                    ...
                    <div class="request-section">
                        ...
                        <div class="request-field">
                            ...
                            <label>
                                Industries & Programs Registering For
                                <span>*</span>
                            </label>
                            ...
                            <div class="activities-box">
                                ...
                                <div class="activity-option">
                                    ...
                                    <input type="checkbox" id="activity-oil" name="activities[]"
                                        value="OIL, GAS & PETROCHEMICALS" {{ in_array(
    'OIL, GAS & PETROCHEMICALS',
    old('activities', [])
) ? 'checked' : '' }}>

                                    <label for="activity-oil">
                                        OIL, GAS &amp; PETROCHEMICALS
                                    </label>
                                ...
                                <div class="activity-option">
                                    ...
                                    <input type="checkbox" id="activity-aerospace" name="activities[]"
                                        value="AEROSPACE & AVIATION" {{ in_array(
    'AEROSPACE & AVIATION',
    old('activities', [])
) ? 'checked' : '' }}>

                                    <label for="activity-aerospace">
                                        AEROSPACE &amp; AVIATION
                                    </label>
                                ...
                                <div class="activity-option">
                                    ...
                                    <input type="checkbox" id="activity-chemical" name="activities[]"
                                        value="CHEMICALS & LUBRICANTS" {{ in_array(
    'CHEMICALS & LUBRICANTS',
    old('activities', [])
) ? 'checked' : '' }}>

                                    <label for="activity-chemical">
                                        CHEMICALS &amp; LUBRICANTS
                                    </label>
                                ...
                                <div class="activity-option">
                                    ...
                                    <input type="checkbox" id="activity-mining" name="activities[]"
                                        value="MINING & DRILLING" {{ in_array(
    'MINING & DRILLING',
    old('activities', [])
) ? 'checked' : '' }}>

                                    <label for="activity-mining">
                                        MINING &amp; DRILLING
                                    </label>
                                ...
                                <div class="activity-option">
                                    ...
                                    <input type="checkbox" id="activity-lab" name="activities[]" value="LAB EQUIPMENT"
                                        {{ in_array(
    'LAB EQUIPMENT',
    old('activities', [])
) ? 'checked' : '' }}>

                                    <label for="activity-lab">
                                        LAB EQUIPMENT
                                    </label>
                                ...
                                <div class="activity-option">
                                    ...
                                    <input type="checkbox" id="activity-rail" name="activities[]" value="RAILWAYS" {{ in_array(
    'RAILWAYS',
    old('activities', [])
) ? 'checked' : '' }}>

                                    <label for="activity-rail">
                                ...
                                <div class="activity-option">
                                    ...
                                    <input type="checkbox" id="activity-rail" name="activities[]" value="OTHERS" {{ in_array(
    'OTHERS',
    old('activities', [])
) ? 'checked' : '' }}>
                            ...
                            <div class="request-required-note">
                                <strong>*</strong>
                                Select one or more Industries that apply.
                            </div>
                        ...
                        <div class="request-grid single">

                            <div class="request-field">

                                <label>
                                    Item Part Number <span>*</span>
                                </label>

                                <input type="text" name="item_part_number" value="{{ old('item_part_number') }}"
                                    placeholder="Enter item or part number" required>
                    ...
                    <div class="request-section">
                        ...
                        <div class="request-grid single">
                            ...
                            <div class="request-field">
                                ...
                                <textarea name="description_manufacturer_quantity"
                                    placeholder="Tell us the product description, manufacturer and required quantity..."
                                    required>{{ old('description_manufacturer_quantity') }}</textarea>
                    ...
                    <div class="request-submit-wrap">

                        <div class="request-submit-info">
                        ...
                        <button type="submit" class="btn btn-primary request-submit">
                            Submit Request
